...
static const int sidepad            = 7;       /* horizontal padding for bar */
...
static const char *notes[] = { "/usr/bin/QOwnNotes", NULL };
static const char *lock[] = { "/usr/local/bin/slock", NULL };
static const char *top[] = { "st", "htop", NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_h,      spawn,          {.v = top } },
